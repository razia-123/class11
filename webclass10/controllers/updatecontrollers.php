...
//message
   ...
   $query = "UPDATE datas SET name='$name',mobile ='$mobile',email='$email',password='$password',message='$message' WHERE id='$postId'";
          

    mysqli_query($conn,$query);

    if($result){
        $_SESSION['msg']="contact info has been update successfully";
        header("Location: ./../edit.php?id=$postId");
        }else{
